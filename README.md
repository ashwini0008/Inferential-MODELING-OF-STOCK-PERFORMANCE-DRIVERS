...
- Time series analysis to see how these relationships evolve
- Including more macroeconomic variables
- Sector-specific analysis
- Machine learning models for prediction (though that's a different beast!)
...
*This project uses publicly available financial data and is for educational and research purposes only. Not financial advice!*